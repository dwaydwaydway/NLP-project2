...
SaveModel = "ModelWeightA_" + str(NUMofEPOCH) + "_" + str(MAXSEQLEN) + ".model"
SaveConfig = "ModelConfigA_" + str(NUMofEPOCH) + "_" + str(MAXSEQLEN) + ".config"
SaveSubmission = "SubmissionA_" + str(NUMofEPOCH) + "_" + str(MAXSEQLEN) + ".csv"
