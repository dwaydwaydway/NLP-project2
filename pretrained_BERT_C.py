...
SaveModel = "ModelWeightC_" + str(NUMofEPOCH) + "_" + str(MAXSEQLEN) + ".model"
SaveConfig = "ModelConfigC_" + str(NUMofEPOCH) + "_" + str(MAXSEQLEN) + ".config"
SaveSubmission = "SubmissionC_" + str(NUMofEPOCH) + "_" + str(MAXSEQLEN) + ".csv"
